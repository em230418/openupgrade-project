...
echo "create database ${PGDATABASE}14 with template ${PGDATABASE} owner odoo;" | psql -h localhost -p 5433 postgres odoo
...
cat fixes_v14.sql | psql -h localhost -p 5433 ${PGDATABASE} odoo
...
# upload fixes for migration
cat fixes_v16.sql | psql -h localhost -p 5433 ${PGDATABASE} odoo
